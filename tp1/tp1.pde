...
// A. EL CARTEL SUPERIOR (Franja verde y texto)
  fill(#7AD183); // Verde manzana brillante
 rect(400, 0, 400, 50); // Rectángulo solo en la mitad derecha
...
quad (700,380,713,380,710,371,715,360);
  ...
  // --- Triángulo 1 (Verde azulado, más bajo y a la izquierda) ---
  fill(46, 204, 113); // Verde azulado translúcido
  ...
  // --- Triángulo 2 (Verde pasto, el más alto y central) ---
  fill(46, 204, 113); 
  stroke(#3AA59D);
  strokeWeight(10);
...
ellipse (661,392,20,20);
  ...
  fill(100, 30, 100); // Texto púrpura
  textSize(25);
  text("JUNTAS         SOMOS        MAS", 500, 25); // Centrado en la mitad derecha
 


  

  // E. EL SUELO (PIEZA DE CONCRETO)
  fill(155);
  rect(390, 380, 400, 20); // El piso gris solo a la derecha
